...
Reading  the Chapter 8 of *Right Kind of Wrong* by Amy Edmondson provided the theoretical framework, I needed to process these failures. Her concept of **"Intelligent Failure"** was particularly liberating. I learned that the MCO was a "Basic Failure" that could have been avoided, but we need to allow for experimentation where failure leads to discovery. This necessitates "Psychological Safety," wherein team members are encouraged to voice discrepancies prior to their escalation.
